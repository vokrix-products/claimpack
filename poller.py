...
the job completed. Also scans records for claims expiring soon or
overdue and creates dashboard notifications.
"""
...
def scan_expirations():
    """Create bell notifications for claims expiring soon or already overdue."""
